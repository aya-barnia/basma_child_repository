...
import 'package:basma_child/view/lessons_view.dart';
      ...
      child: BlocConsumer<ClassesCubit,ClassesState>(
        listener: (BuildContext context , Object state){
          ...
          if(state is GetAllTitle){
            ...
            print(state.subId.toString());

            Navigator.push(context, MaterialPageRoute(builder: (BuildContext context)=> LessonsView(state.subId,state.cal)));
